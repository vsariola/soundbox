...
var CGUI = function()
{
  ...
  var soundboxBinToSong = function (d) {
    ...
    for (i = 0; i < song.numChannels; i++) {
      ...
      if (version < 6) {
        ...
        instr.i[OSC1_XENV] = 8 * bin.getUBYTE();
        ...
        instr.i[OSC1_VOL] = bin.getUBYTE();
        instr.i[OSC1_SEMI] = bin.getUBYTE();
        instr.i[OSC1_XENV] = version < 13 ? 8 * bin.getUBYTE() : bin.getUBYTE();
      }
      ...
      if (version < 6) {
        ...
        instr.i[OSC2_XENV] = 8 * bin.getUBYTE();
        ...
        instr.i[OSC2_SEMI] = bin.getUBYTE();
        instr.i[OSC2_DETUNE] = bin.getUBYTE();
        instr.i[OSC2_XENV] = version < 13 ? 8 * bin.getUBYTE() : bin.getUBYTE();
      }
  ...
  var binToInstrument = function (d) {
    ...
    instrI[OSC1_XENV] = version < 2 ? 8 * bin.getUBYTE() : bin.getUBYTE();
    ...
    instrI[OSC2_XENV] = version < 2 ? 8 * bin.getUBYTE() : bin.getUBYTE();
...
//    window.status = msg;
  ...
  this.init = function ()
  {
    ...
    document.getElementById("osc1_xenv").sliderProps = { min: 0, max: 64 };
    ...
    document.getElementById("osc2_xenv").sliderProps = { min: 0, max: 64 };
